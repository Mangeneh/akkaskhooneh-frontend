...
export default (state = INITIAL_STATE, action) => {
    const {EMAIL_CHANGED, SIGN_UP_RESET, PASSWORD_CHANGED, REPEATED_PASSWORD_CHANGED, VALIDATE_EMAIL, VALIDATE_EMAIL_FAIL, VALIDATE_EMAIL_SUCCESS, EMAIL_RESET} = Actions;
    switch (action.type) {
        case EMAIL_CHANGED:
            return {
                ...state,
