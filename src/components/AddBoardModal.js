    ...
    render() {
        return (
            <View style={styles.modalContent}>
                ...
                }}>{strings(Strings.ADD_TO_INTERESTS)}</Text>
                ...
                <Item style={{flexDirection: 'row', backgroundColor: Colors.LIGHT_GRAY}}>
                    ...
                    }} onChangeText={this.props.onNameChange} placeholder={strings(Strings.CREATE_NEW_BOARD)}
                           value={this.props.value}/>
                    <TouchableOpacity>
                        <Icon name='plus' type='Entypo'
                              style={{color: Colors.BASE, justifyContent: 'flex-end', alignSelf: 'center'}}
